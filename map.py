...
if departing_airport_readable and departing_airport_readable == arriving_airport_readable:
    ...
    # Getting X and Y coordinate of each airports by parsing a row
    ...
    # Determing the nodes in the circle created in the midpoint
    ...
    popular_100_airport_filtered_df['LONGITUDE'] = pd.to_numeric(
        popular_100_airport_filtered_df['LONGITUDE'], errors='coerce'
    )
